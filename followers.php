<?php
	...
	$id_user = $_SESSION['followers_id_user'];
...
<nav class="navbar navbar-expand-md navbar-light d-flex justify-content-between" style="background-color: #e3f2fd; opacity: 0.5;">
	<div class="mx-auto order-0">
		<a class="navbar-brand mx-auto" href="feed.php"><?php echo "$username's" ?> followers <i class="fa fa-eye" aria-hidden="true"></i></a>
	</div>
</nav>
	...
	<div style="margin-left: auto; margin-right: auto;">
		<div style="padding: 10px;">
			<form action="followers.php" method="post">
				...
				<input type="text" hidden = "true"  name="profile_id_user" value="<?php echo $row['follower'] ?>" >
